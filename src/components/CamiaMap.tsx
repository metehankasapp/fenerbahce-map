...
export function CamiaMap(){
  ...
  const positions=useRef(new Map<string,SimNode>()); const [selected,setSelected]=useState<MapNode|null>(null); const [query,setQuery]=useState(""); const [hint,setHint]=useState("Bir camia ara veya haritayı keşfet");
