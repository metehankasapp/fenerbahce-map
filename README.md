...
Uygulama `http://localhost:3000` adresinde açılır. Supabase değişiklikleri `supabase/` klasöründedir. Oy özelliği kullanılmayacaksa ortam değişkenleri zorunlu değildir.
